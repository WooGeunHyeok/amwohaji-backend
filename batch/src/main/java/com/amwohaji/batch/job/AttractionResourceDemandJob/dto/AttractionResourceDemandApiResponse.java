...
public class AttractionResourceDemandApiResponse {
    // 큰 껍데기 <response>
    ...
    public static class Item {
        ...
        private String hubTatsCd;       // 중심지관광지코드
        private String hubTatsNm;       // 중심지관광지명
        private String hubCtgryLclsNm;  // 중심지카테고리대분류명
        private String hubCtgryMclsNm;  // 중심지카테고리중분류명
        private int hubRank;            // 중심지 순위 (아까 정한 대로 int 타입)
    }
